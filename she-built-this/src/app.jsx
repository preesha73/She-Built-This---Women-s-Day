...
const women = [
  ...
  },
  {
    ...
    icon: "🖥️",
    contribution:
      "Invented the first compiler — a tool that translates human-readable code into machine code. She also popularized the term 'debugging' and led development of COBOL, the language that still runs global banking today.",
  ...
  },
  {
    ...
    icon: "🚀",
    contribution:
      "Led the team that developed the on-board flight software for NASA's Apollo missions. Her error-detection code saved Apollo 11 from aborting mid-mission. She coined the term 'software engineering.'",
  ...
  },
  {
    ...
    icon: "🛸",
    contribution:
      "Developed and implemented code for NASA's Centaur rocket — the technology that now powers modern satellite launches. As one of NASA's first Black employees, she also mentored underrepresented groups throughout her career.",
  ...
  },
  {
    ...
    icon: "🌐",
    contribution:
      "Invented the Spanning Tree Protocol (STP), the foundational algorithm that allows modern network bridges to work. Without her invention, the internet as we know it — including every website and app — could not function.",
  ...
  },
  {
    ...
    icon: "📡",
    contribution:
      "Co-invented frequency-hopping spread spectrum technology during WWII to make torpedo guidance systems harder to jam. This exact technology became the foundation of WiFi, Bluetooth, and GPS — technologies we all use daily.",
  ...
  },
  {
    ...
    icon: "💻",
    contribution:
      "Founded Girls Who Code, an organization that has taught over 500,000 girls to code across 50 states and 6 countries. She's directly responsible for reshaping the gender ratio in tech's next generation.",
...
function TimelineNode({ woman, index, isSelected, onClick, isVisible }) {
  ...
  return (
    ...
    >
      <div className="timeline-card" onClick={() => onClick(woman)} style={{ borderColor: isSelected ? woman.color : "transparent" }}>
        <div className="card-year" style={{ color: woman.accent }}>
          {woman.year}
        </div>
        <div className="card-icon">{woman.icon}</div>
        <div className="card-name">{woman.name}</div>
        <div className="card-title">{woman.title}</div>
        <div className="card-field" style={{ color: woman.accent }}>
          {woman.field}
        </div>
...
function DetailPanel({ woman, onClose }) {
  ...
  return (
    <div className="detail-overlay" onClick={onClose}>
      <div className="detail-panel" onClick={(e) => e.stopPropagation()} style={{ "--wcolor": woman.color, "--waccent": woman.accent }}>
      ...
      <div className="content">
        <header className="hero">
          ...
          <p className="hero-sub">
            ...
            <br />
            <span className="hero-hint">Click any card to explore her story →</span>
          </p>
        </header>
        ...
        <footer className="footer">
          ...
          <div className="footer-sub">Full-Stack Developer · Vellore Institute of Technology · Sarvm.AI</div>
        </footer>
      </div>
